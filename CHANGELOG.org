...
# Each release follows: * [vX.Y] — YYYY-MM-DD :: Short Title
#
#   [TODO] — Bugs, features, infrastructure
#   [Unreleased]
#   [v0.3] — Vue App + CAM-LOG Overlay + Landing Index
#   [v0.1] — Brand Bootstrap
#
# Guidelines:
#   Entries: *Summary:* hook, *** sub-grouped Added/Changed/Removed/Decided
#   Decided items: bolded title with rationale
#   No arrows, no emojis, no private-file references
#   Bare facts only, decisions carry rationale
#
...
- =src/brands/kyonax-on-tech/cam-log.vue= — CAM-LOG HUD at =/@kyonax_on_tech/cam-log=
